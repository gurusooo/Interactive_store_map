...
export function RoutePage() {
  ...
  const getPopupPosition = () => {
    ...
    const deptCenterX =
      (selectedDept.x + selectedDept.width / 2) * scale + rect.left + transform.offsetX;
    const deptCenterY =
      (selectedDept.y + selectedDept.height / 2) * scale + rect.top + transform.offsetY;
